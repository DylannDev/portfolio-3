...
export const projects = [
  {
    id: 1,
    title: "Zen Lounge – Institut de massages et bien-être",
    slug: "zenlounge",
    des: "Institut de bien-être spécialisé dans les massages personnalisés et la location d’un appartement en courte durée.",
    img: "/zenlounge.png",
    iconLists: [
      "/next.svg",
      "/tail.svg",
    ...
    linkDemo: "https://zenlounge-guyane.fr",
    linkGithub: "zenlounge",
    isClientProject: true,
    paragraphs: [
      "Zen Lounge est un institut de bien-être spécialisé dans les massages personnalisés et la location d’un appartement en courte durée. La propriétaire souhaitait digitaliser l’intégralité de son activité : prise de rendez-vous, vente de forfaits, gestion des disponibilités, et paiements.",
      "La cliente a pu automatiser toute sa gestion quotidienne, offrir une expérience fluide à ses clients, et augmenter les ventes de forfaits. Le site est désormais un levier clé de son activité, avec une image professionnelle alignée sur la qualité de ses prestations.",
    ],
    features: [
      "Réservation de créneaux dynamiques selon les disponibilités",
      "Dashboard admin pour suivi et gestion de l'activité",
      "Achat de forfaits avec compteur de sessions restantes",
      "Paiement en ligne avec Stripe + envoi d’un récapitulatif automatique",
      "Connexion sécurisée via Firebase Auth",
      "Espace personnel : annulation de séance, historique des réservations, forfait actif",
      "Réservation de l’appartement via sélection de dates disponibles",
      "UI/UX Design personnalisé, optimisé conversion",
    ],
  },
  {
    id: 2,
