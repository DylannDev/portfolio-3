...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative overflow-hidden rounded-3xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none justify-between space-y-4 border border-white/[0.1]",
        className
      )}
      style={{
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-2 lg:gap-3 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-2 lg:gap-3">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132e]" />
                {[, "TailwindCSS", "MongoDB", "Firebase"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]"
                  >
